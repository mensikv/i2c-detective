...
// Categories
const char Accelerometer[]                        PROGMEM = "Accel";
const char AccelerometerGyroscope[]               PROGMEM = "Accel/Gyro";
const char AccelerometerGyroscopeMagnetometer[]   PROGMEM = "Accel/Gyro/Magn";
const char AccelerometerMagnetometer[]            PROGMEM = "Accel/Magn";
const char AirQualitySensor[]                     PROGMEM = "Air Quality Sens";
const char Amplifier[]                            PROGMEM = "Amplifier";
const char AnaloguetoDigitalConverter[]           PROGMEM = "Anal to Digi Converter";
const char ADCDAC[]                               PROGMEM = "ADC/DAC";
const char CapacitiveTouchSensor[]                PROGMEM = "Capacitive Touch Sens";
const char ClockGenerator[]                       PROGMEM = "Clock Generator";
const char CO2Sensor[]                            PROGMEM = "CO2 Sens";
const char ColourSensor[]                         PROGMEM = "Colour Sens";
const char CryptographicDevice[]                  PROGMEM = "Cryptographic Device";
const char CurrentVoltageSensor[]                 PROGMEM = "Current/Voltage Sens";
const char CurrentPowerSensor[]                   PROGMEM = "Current/Power Sens";
const char DigitaltoAnalogueConverter[]           PROGMEM = "Digi to Anal Converter";
const char DigitalCapacitor[]                     PROGMEM = "Digi Capacitor";
const char DigitalPotentiometer[]                 PROGMEM = "Digi Potentiometer";
const char DSPRadio[]                             PROGMEM = "DSP Radio";
const char FanController[]                        PROGMEM = "Fan Cont";
...
const char GasSensor[]                            PROGMEM = "Gas Sens";
const char GPIOExpander[]                         PROGMEM = "GPIO Expander";
const char GPSGNSSReceiver[]                      PROGMEM = "GPS GNSS Receiver";
const char Gyroscope[]                            PROGMEM = "Gyro";
const char HumidityTemperatureSensor[]            PROGMEM = "Humi/Temp Sens";
const char IRTemperatureSensor[]                  PROGMEM = "IR Temp Sens";
...
const char LightColourSensor[]                    PROGMEM = "Light/Colour Sens";
const char LightSensor[]                          PROGMEM = "Light Sens";
const char LoadCellScale[]                        PROGMEM = "Load Cell Scale";
const char Magnetometer[]                         PROGMEM = "Magn";
...
const char NunchuckController[]                   PROGMEM = "Nunchuck Cont";
const char OLEDDisplay[]                          PROGMEM = "OLED Display";
const char PowerManagementIC[]                    PROGMEM = "Power Management IC";
const char PressureSensor[]                       PROGMEM = "Press Sens";
const char ProximitySensor[]                      PROGMEM = "Proximity Sens";
const char ProximityLightSensor[]                 PROGMEM = "Proximity/Light Sens";
const char PulseOximetrySensor[]                  PROGMEM = "Pulse & Oximetry Sens";
...
const char ResistiveTouchController[]             PROGMEM = "Resistive Touch Cont";
const char RFIDTag[]                              PROGMEM = "RFID Tag";
const char TemperatureSensor[]                    PROGMEM = "Temp Sens";
const char TemperatureHumiditySensor[]            PROGMEM = "Temp/Humi Sens";
const char TemperaturePressureSensor[]            PROGMEM = "Temp/Press Sens";
const char TemperaturePressureHumiditySensor[]    PROGMEM = "Temp/Press/Humi Sens";
const char TemperaturePressureHumidityGasSensor[] PROGMEM = "Temp/Press/Humi/Gas Sens";
const char ThermocoupleAmplifier[]                PROGMEM = "Thermocouple Amplifier";
const char TimeofFlightSensor[]                   PROGMEM = "Time of Flight Sens";
const char TriadSpectroscopySensor[]              PROGMEM = "Triad Spectroscopy Sens";
const char UVLightSensor[]                        PROGMEM = "UV Light Sens";
const char VOCSensor[]                            PROGMEM = "VOC Sens";
const char WaterSensor[]                          PROGMEM = "Water Sens";
...
void list (uint8_t addr, const device_t *me) {
  char txt[100];
  tft.setTextPadding(TFT_HEIGHT);
  //Serial.printf("X/Y position: %i, %i\n", xpos,ypos);
  
  sprintf(txt, "0x%x ", addr);  
  tft.setTextColor(TFT_RED, TFT_BLACK);
  tft.drawString(txt, xpos, ypos);
  xpos += tft.textWidth(txt);
  //Serial.printf("X/Y position: %i, %i\n", xpos,ypos);
  
  sprintf(txt, "%s: ", me->category);
  ...
  tft.drawString(me->device, xpos, ypos);
...
void setup () {
  ...
  //Serial.println(F("I2C detective"));
  ...
  tft.setTextFont(1);
  tft.setTextDatum(TL_DATUM); // reference point for text drawing - TOP LEFT
}

void loop () { 
  tft.setTextSize(2);
  tft.setTextColor(TFT_WHITE);
  tft.drawString("I2C Detective", 0, 0);
  
  tft.fillRoundRect(197, 2, 20, 10, 2, TFT_YELLOW);
  tft.fillRoundRect(219, 2, 20, 10, 2, TFT_GREEN);
  tft.setTextColor(TFT_BLACK);
  tft.setTextSize(1);
  tft.drawString("SDA", 198, 3);
  tft.drawString("SCL", 221, 3);

  tft.drawFastHLine(0, 17, 240, TFT_MAGENTA);
